...
// African-inspired pattern (optimized: ~10 elements)
...
export default function PageHeader({
  ...
  return (
    <section className="relative pt-32 pb-28 overflow-hidden">
      ...
      <div
        className="absolute top-1/4 left-1/3 w-3 h-3 bg-secondary/40 rounded-full blur-sm animate-pulse"
      ...
      <div className="absolute bottom-0 left-0 right-0">
        ...
        >
          <path
            d="M0 80L48 72C96 64 192 48 288 40C384 32 480 32 576 40C672 48 768 64 864 68C960 72 1056 64 1152 56C1248 48 1344 40 1392 36L1440 32V80H0Z"
            fill="var(--background)"
          />
        </svg>
      </div>
