    ...
    <>
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-dark via-primary to-dark overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          >
            Des services administratifs efficaces au service de la communauté.
          </motion.p>
        </div>
      </section>
      <section className="section-padding">
        <div className="container-custom">
          <SectionTitle
            ...
            subtitle="Une équipe administrative dédiée pour accompagner élèves et parents."
          />
            ...
            {[
              {
                icon: Building2,
                title: "Direction",
                desc: "Proviseur et Proviseur Adjoint",
              },
              {
                icon: FileText,
                title: "Scolarité",
                desc: "Inscriptions, bulletins, diplômes",
              },
              {
                icon: Users,
                title: "Orientation",
                desc: "Conseillers d'orientation",
              },
              {
                icon: Clock,
                title: "Horaires",
                desc: "Lun-Ven : 7h30 - 16h30",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
